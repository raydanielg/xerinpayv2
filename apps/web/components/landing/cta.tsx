  ...
  return (
    <section className="px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
      <Reveal className="mx-auto max-w-7xl">
        <div className="relative isolate overflow-hidden rounded-3xl border border-border/60 bg-gradient-to-br from-orange-500/12 via-card to-amber-500/10 px-6 py-16 text-center shadow-xl sm:px-12 sm:py-20">
          <div
            aria-hidden
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-full size-[32rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500/20 blur-[110px]"
          />
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Button render={<Link href="/auth/register" />} size="lg" className="group h-12 w-full px-7 text-base sm:w-auto">
